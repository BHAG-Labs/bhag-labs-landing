...
// 2026-07-05: the site is single-product now — DOSSIER (three sentences in,
// an investor-ready deck out). The old multi-product landing and the other
// product pages live in src/unreleased/ (not routed, so not bundled) until
// they're ready to ship. To resurrect one, move it back under src/pages and
// restore its route below.
//
